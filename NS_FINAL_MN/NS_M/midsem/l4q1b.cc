...
main (int argc, char *argv[])
{
  ...
  NodeContainer c;
  c.Create (5);
  NodeContainer c0 = NodeContainer (c.Get (0), c.Get (1));                            //i
  ...
  NetDeviceContainer n0 = pp.Install (c0);           //i
  NetDeviceContainer n1 = csma.Install (c1);         //c
  ...
  ipv4.Assign (n0);                                  //i
  ipv4.SetBase ("192.168.1.0", "255.255.255.0");     //i
  ipv4.Assign (n1);
  ...
  ApplicationContainer app = onoff.Install (c0.Get (1));                           // c     [n1]
  ...
  app = sink.Install (c0.Get (0));                        //c
  app.Add (sink.Install (c1.Get (1)));                     //c      
  app.Start (Seconds (1.0));
  app.Stop (Seconds (10.0));
  ...
  csma.EnableAsciiAll (ascii.CreateFileStream ("l4q1b.tr"));     //i
