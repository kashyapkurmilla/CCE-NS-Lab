...
Configure Tracing.
Run Simulation.
At time +5.01569s on-off application sent 128 bytes to 225.1.2.4 port 9 total Tx 128 bytes
At time +9.03137s on-off application sent 128 bytes to 225.1.2.4 port 9 total Tx 256 bytes
Done.
