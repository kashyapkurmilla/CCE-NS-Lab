...
int main (int argc, char *argv[])
{
  ...
  NetDeviceContainer n6n7 = p2p.Install(nodes.Get(6), nodes.Get(7)); //6,7
  NetDeviceContainer n6n8 = p2p.Install(nodes.Get(6), nodes.Get(8)); //6,8
  NetDeviceContainer n7n9 = p2p.Install(nodes.Get(7), nodes.Get(9)); //7,9
  NetDeviceContainer n8n9 = p2p.Install(nodes.Get(8), nodes.Get(9)); // 8,9
