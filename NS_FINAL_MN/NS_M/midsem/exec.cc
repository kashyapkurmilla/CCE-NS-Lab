...
int main(int argc, char *argv[])
{
    ...
    ApplicationContainer clientApps = echoClient.Install(nodes.Get(0)); // Install client on node 0 (n0)
    clientApps.Start(Seconds(2.0));
    clientApps.Stop(Seconds(10.0));

    AnimationInterface anim("madhu_exec_f.xml");
    ...
    p2p.EnableAsciiAll(ascii.CreateFileStream("madhu_exec.tr"));
