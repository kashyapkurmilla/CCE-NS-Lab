...
main (int argc, char *argv[])
{
  ...
  //q_mobility in Node N2, N3, N6 to displace these nodes 50 steps away from the original point at speed of 20 Km/hour.
  ...
  //q_node N9 starts communicating to node NI at 1" second and ends its communication at 5th second using the TCP application.
  ...
  //q_generate 90 packets of 1024 bytes
