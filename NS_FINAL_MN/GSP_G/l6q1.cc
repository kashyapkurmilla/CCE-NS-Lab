...
int main (int argc, char **argv)
{
  ...
  ripNgRouting.SetInterfaceMetric (c, 3, 10);  //interface 3 on node c to 10.
  ripNgRouting.SetInterfaceMetric (d, 1, 10); //interface 1 on node d

  Ipv6ListRoutingHelper listRH;
  listRH.Add (ripNgRouting, 0);  //0, indicates the priority 
  Ipv6StaticRoutingHelper staticRh;
  listRH.Add (staticRh, 5); // priority of 5
 ...
 //interfaces 3 on node b and 2 on node d.
