// Network topology
 ...
 int main (int argc, char **argv)
 {
   ...
   ripRouting.SetInterfaceMetric (c, 3, 10); //interface 3 on node c to 10.
   ripRouting.SetInterfaceMetric (d, 1, 10); //interface 1 on node d
 
   Ipv4ListRoutingHelper listRH;
   listRH.Add (ripRouting, 0); //0, indicates the priority 
